...
## Visual direction (from the Figma site)

- Near-black navy background with a subtle blue glow, electric blue accent (`#4f7cff`-family), wide geometric display headings, soft rounded corners.
...
- Restrained motion: hover lift on cards, gentle fade/rise on scroll. No heavy animation.

## Pages

**Home (`/`)**
- Sticky nav: ZYN logo, Home / About / Work / Contact, "Hire Me" button.
- Hero: "ROBLOX FREELANCE PORTFOLIO" eyebrow, `Roblox QA Tester & Community Specialist`, intro line, View My Work + Contact Me buttons, glass hero visual.
...
- Work preview: six cards, link through to the full archive.
